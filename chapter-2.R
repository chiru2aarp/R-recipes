...
str(carslist[1])
#
#Recipe: Create random data partitions
#---------------------------------------
library(caret)
bh <- read.csv("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/BostonHousing.csv")
...
bh2 <- read.csv("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/boston-housing-classification.csv")
...
#
#Recipe: Generating standard plots (histograms, boxplots and scatterplots
#---------------------------------------------------------------------
auto <- read.csv("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/auto-mpg.csv")
...
#---------------------------------------------
auto <- read.csv("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/auto-mpg.csv", stringsAsFactors=FALSE)
...
#Recipe: Create charts that facilitate comparisons
#--------------------------------------------------
bike <- read.csv("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/daily-bike-rentals.csv")
...
#Recipe: Create charts that help to visualize possible causality
#-----------------------------------------------------------------
bike <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/4/daily-bike-rentals.csv")
bike$season <- factor(bike$season, levels = c(1,2,3,4),
  labels = c("Spring", "Summer", "Fall", "Spring"))
