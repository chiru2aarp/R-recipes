...
pie(pct,col = col, radius = 1, init.angle = 90, clockwise = TRUE, labels =labels, 
    main = "Traumatic Brain Injury 2000-2014(Q2)")
# *********************************
# ***Pie charts with barplots******
# *********************************
data2 = read.table("~/../Downloads/Analytics/Books/R Recipes/module 2/4/service.csv", 
                   header = TRUE, sep = ",")
...
textbox(c(2.5,3.5),3.5,c("Traumatic Brain Injury: 2000- 2014"),cex = 1, justify ="c",
        box = FALSE)
# *************************************
...
# ***Slope Charts**********************
# *************************************
data = read.csv("~/../Downloads/Analytics/Books/R Recipes/module 2/4/mortality1.csv")
