...
library(quantmod)
prices = c("MSFT","FB")
#will download the data for given stock's
getSymbols(prices)
#class(MSFT$MSFT.Volume)
...
# **********************************
data = read.csv("~/../Downloads/Analytics/Books/R Recipes/module 2/7/data/fredgraph.csv")
...
acf(m) # generates a correlogram(lag included)
# ************************************
# *** Theres More: fan plot in R******
# ************************************
#install.packages(c("fanplot"))
library(forecast)
library(fanplot)
