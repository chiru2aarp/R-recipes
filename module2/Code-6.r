...
library(HistData)
library(plotrix)
data1 = Nightingale[13:24,]
month = c("Apr 1855","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec","Jan 1856", "Feb","Mar")
radial.pie(data1$Disease,labels=month, boxed.radial = FALSE,sector.colors =c(rep("#60B1FF",12)),grid.colo= white, grid.col= "white", radlab= TRUE, mar=c(2,10,2,10),show.grid.labels = 0, label.prop= .9)
## to add grid 
