...
#------------------------------------------------------
cp <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/college-perf.csv")
...
dat <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/roc-example-1.csv")
...
dat <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/roc-example-2.csv")
...
bn <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/banknote-authentication.csv")
set.seed(1000)
...
ep <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/electronics-purchase.csv")
...
vac <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/vacation-trip-classification.csv")
...
bh <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/boston-housing-logistic.csv")
...
bh <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/5/data/banknote-authentication.csv")
