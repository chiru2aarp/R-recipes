...
#----------------------------------------------------------
auto <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/7/data/auto-mpg.csv")
...
bh <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/7/data/BostonHousing.csv") 
