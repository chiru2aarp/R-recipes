...
library(RgoogleMaps)
wages <- read.csv("~/Downloads/Books/Analytics_DS/R/R Recipes/module 1/12/data/nj-wages.csv")
wages$wgclass <- cut(wages$Avgwg, quantile(wages$Avgwg, probs=seq(0,1,0.20)), labels=FALSE, include.lowest=TRUE)
...
library(sp)
library(rgdal)
setwd("C:/Users/CHIRANJEEVI/Downloads/Books/Analytics_DS/R/R Recipes/module 1/12/data")
