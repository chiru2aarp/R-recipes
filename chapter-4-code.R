...
dat <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/rmse-example.csv")
...
rmse1 <- rdahb.rmse(dat$price, dat$pred)
...
educ <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/education.csv")
...
rmse1 = rdahb.rmse(res1$pred, val[,6])
...
auto <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/auto-mpg.csv")
...
names(auto)
# linear model on num data with one factor cyl, and year is not arthematic...
...
bh <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/BostonHousing.csv")
...
prp(bfitpruned, type=2, nn=TRUE, fallen.leaves=TRUE, faclen=8, varlen=8, shadow.col="gray")
...
ed <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/education.csv")
...
bn <- read.csv("~/../Downloads/Analytics/Books/R Recipes/module 1/6/data/BostonHousing.csv")
set.seed(1000)
t.idx <- createDataPartition(bh$MEDV, p=0.7, list=FALSE)
...
if(!exists("nnet_plot_update", mode="function")) source("~/../Downloads/Analytics/Books/R Recipes/module 1/6/code/nnet_plot_update.R")
